...
Public Class GoToTypeDefinitionTestsBase
    Protected Shared Async Function TestAsync(
        ...
        Using workspace = EditorTestWorkspace.Create(workspaceDefinition, composition:=GoToTestHelpers.Composition)
            ...
            Dim defLocationAndSpan = Await goToDefService.GetTypeDefinitionLocationAsync(
    ...
    Protected Shared Async Function TestAsync(source As String, language As String, Optional expectedResult As Boolean = True) As Task
        Await TestAsync(
               <Workspace>
